...
In the [optional section](#optional-strong-convergence-of-the-euler-maruyama-method-applied-to-the-ou-process) we will show that mathematically, Euler-Maruyama discretization and the exact method are very "close", and their differences are bounded.
