...
date: 2024-06-13
description: "In the previous post of this series, we introduced the problem of Malaria detection and prepared and preprocessed our dataset."
categories: [Machine Learning, Computer Vision, Deep Learning, Healthcare AI]
content-type: "series"
series-id: "malaria-detection"
series-title: "Malaria Detection"
series-part: 2
project-ids: [malaria-detection]
---
...
## Recap
In the [previous post](../malaria-detection-1/) of this series, we introduced the problem of Malaria detection and prepared and preprocessed our dataset. Now, let's build and train a few deep-learning models to see if we can detect Malaria with good accuracy and recall.
...
## Wrapping Up
In the [next post](../malaria-detection-3/) of this series, we'll discuss the results, draw insights, and explore potential improvements to our malaria detection system. Stay tuned!
