...
2. Apply Itô's lemma to $P(t,T)$ (Try!)
 ...
 $$
rac{dP}{P} = \left[\frac{\partial A}{\partial t}\frac{1}{A} - \frac{\partial B}{\partial t} r - \mu B + \frac{1}{2} B^2 \sigma^2\right]dt - \sigma B dW_t$$
...
4. Equate coefficients of $r$ and constant terms, we get two equations:
 ...
 $$
rac{\partial A}{\partial t}\frac{1}{A} - \mu B + \frac{1}{2}B^2\sigma^2 = 0$$
