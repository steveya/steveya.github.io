...
math: true
description: >-
  Previously I provided some motivations for the use of signatures. In particular, I have always been interested in methods that encode
  information about time series in a way that can be used by downstream learning algorithms. In this note I start with the definition of
  signatures, and then illustrate the universal approximation property with a few examples. These examples will also demonstrate the
  importance of path construction, mentioned at the end of the last post.
---
